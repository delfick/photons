...
`example <https://github.com/delfick/photons-core/blob/main/examples/tile_animation>`_
is a good place to start for making your own animation and the
`folder <https://github.com/delfick/photons-core/tree/main/modules/photons_canvas/animations/registered>`_
...
post a `question <https://github.com/delfick/photons-core/issues>`_ on the
