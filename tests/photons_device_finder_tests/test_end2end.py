...
device1 = FakeDevice("d073d5000001"
    , chp.default_responders(LIFIProductRegistry.LCMV4_BR30_COLOR
...
device2 = FakeDevice("d073d5000002"
...
device3 = FakeDevice("d073d5000003"
    ...
    async it "can be used to get info", runner:
        ...
        async with W() as finder:
            ...
            async with runner.target.session() as afr:
                ...
                self.assertEqual(sorted(found)
                    , sorted([(device1.serial, 65535), (device3.serial, 65535)])
                    )
