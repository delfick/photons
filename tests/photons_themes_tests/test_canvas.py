...
describe TestCase, "Canvas":
    ...
    describe "surrounding_points":
        it "gets the points that surround the provided i, j":
            ...
            self.assertEqual(
                canvas.surrounding_points(-1, 4),
                [(-2, 5), (-1, 5), (0, 5), (-2, 4), (0, 4), (-2, 3), (-1, 3), (0, 3)],
            )

            self.assertEqual(
                canvas.surrounding_points(20, -9),
                [(19, -8), (20, -8), (21, -8), (19, -9), (21, -9), (19, -10), (20, -10), (21, -10)],
            )
    ...
    describe "surrounding_colors":
        it "gets the colors that surround the provided i, j":
            ...
            points = [(0, 3), (1, 3), (2, 3), (0, 2), (1, 2), (2, 2), (0, 1), (1, 1), (2, 1)]

            for i, point in enumerate(points):
                canvas[point] = ThemeColor(i, 0, 1, 3400)

            surrounding = canvas.surrounding_colors(1, 2)
            self.assertEqual([s.hue for s in surrounding], [0, 1, 2, 3, 5, 6, 7, 8])
        ...
        it "ignores points that don't exist":
            ...
            surrounding = canvas.surrounding_colors(1, 2)
            self.assertEqual([s.hue for s in surrounding], [0, 1, 2])
    ...
    describe "blur":
        it "averages all the points with the surrounding colors":
            ...
            self.assertEqual(sorted(canvas), sorted([((1, 1), avg1), ((5, 5), avg2)]))
